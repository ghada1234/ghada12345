...
4.  **Calculate Nutritional Information:** Based on the identified ingredients and their estimated portion sizes, calculate the total nutritional content for the entire meal. Provide estimations for:
    ...
    *   **IMPORTANT**: You MUST provide a numerical value for every nutrient field. If a value cannot be determined, provide your best estimate and set the confidence to 'Low'. DO NOT use 'N/A' or strings. For example, if you are unsure about the vitamin C content of a cooked meal, you might estimate it as 0 or a very low number like 1, not 'unknown'.
